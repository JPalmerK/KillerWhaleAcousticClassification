...
if __name__ == "__main__":
    ...
    dclde_folders = {
        "Background": r"C:\TempData\DCLDE_HOLDOUT_Grid2\Background",
        "HW":         r"C:\TempData\DCLDE_HOLDOUT_Grid2\HW",
        "SRKW":       r"C:\TempData\DCLDE_HOLDOUT_Grid2\SRKW",
        "TKW":        r"C:\TempData\DCLDE_HOLDOUT_Grid2\TKW",
    }
    ...
    GRID = Path(r"C:\Users\kaity\Documents\GitHub\Ecotype\Experiments\BirdnetOrganized\BirdNetGrid2\\")
    
    # ---- model configs (8 kHz cutoff variants you provided) ----
    model_config_01 = {
        "model_path": str(GRID / "birdnet01" / "birdnet01.tflite"),
        "label_path": str(GRID / "birdnet01" / "birdnet01_Labels.txt"),
    }
    model_config_02 = {
        "model_path": str(GRID / "birdnet02" / "birdnet02.tflite"),
        "label_path": str(GRID / "birdnet02" / "birdnet02_Labels.txt"),
    }
    model_config_03 = {
        "model_path": str(GRID / "birdnet03" / "birdnet03.tflite"),
        "label_path": str(GRID / "birdnet03" / "birdnet03_Labels.txt"),
    }
    model_config_04 = {
        "model_path": str(GRID / "birdnet04" / "birdnet04.tflite"),
        "label_path": str(GRID / "birdnet04" / "birdnet04_Labels.txt"),
    }
    model_config_05 = {
        "model_path": str(GRID / "birdnet05" / "birdnet05.tflite"),
        "label_path": str(GRID / "birdnet05" / "birdnet05_Labels.txt"),
    }
    model_config_06 = {
        "model_path": str(GRID / "birdnet06" / "birdnet06.tflite"),
        "label_path": str(GRID / "birdnet06" / "birdnet06_Labels.txt"),
    }
    model_config_07 = {
        "model_path": str(GRID / "birdnet07" / "birdnet07.tflite"),
        "label_path": str(GRID / "birdnet07" / "birdnet07_Labels.txt"),
    }
    model_config_08 = {
        "model_path": str(GRID / "birdnet08" / "birdnet08.tflite"),
        "label_path": str(GRID / "birdnet08" / "birdnet08_Labels.txt"),
    }
    model_config_09 = {
        "model_path": str(GRID / "birdnet09" / "birdnet09.tflite"),
        "label_path": str(GRID / "birdnet09" / "birdnet09_Labels.txt"),
    }
    ...
    metrics_DCLDE_01   = evaluate_model(eval_dclde_birdnet_01,  
                                        custom_thresholds=custom_thresholds_dclde,   pr_title="DCLDE Precision–Recall Curve 01",   roc_title="DCLDE ROC Curve 01")
    metrics_malahat_01 = evaluate_model(eval_malahat_birdnet_01, 
                                        custom_thresholds=custom_thresholds_dclde,   pr_title="Malahat Precision–Recall Curve 01",  roc_title="Malahat ROC Curve 01")
    ...
    AUCDCLDE = pd.DataFrame([
        ...
        metrics_DCLDE_03['AUC'],
                  ...
                  metrics_DCLDE_07['AUC'],
                  metrics_DCLDE_08['AUC'],
                  metrics_DCLDE_09['AUC']]).fillna(0)
...
fig, axes = plot_mcc_grid_1x2_patterns(
    ...
    size_panel_box=(0.04, 0.03, 0.28, 0.30),
